...
namespace Data_Structures_and_Algorithms
{
    public partial class POS_Admin : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                posdb_connect.pos_sql = "INSERT INTO pos_nameTbl (pos_id, name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14, name15, name16, name17, name18, name19, name20) VALUES ('" + pos_id_combobox.Text + "', '" + nametextbox1.Text + "', '" + nametextbox2.Text + "', '" + nametextbox3.Text + "', '" + nametextbox4.Text + "', '" + nametextbox5.Text + "', '" + nametextbox6.Text + "', '" + nametextbox7.Text + "', '" + nametextbox8.Text + "', '" + nametextbox9.Text + "', '" + nametextbox10.Text + "', '" + nametextbox11.Text + "', '" + nametextbox12.Text + "', '" + nametextbox13.Text + "', '" + nametextbox14.Text + "', '" + nametextbox15.Text + "', '" + nametextbox16.Text + "', '" + nametextbox17.Text + "', '" + nametextbox18.Text + "', '" + nametextbox19.Text + "', '" + nametextbox20.Text + "')";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterInsert();
                posdb_connect.pos_sql = "INSERT INTO pos_priceTbl ( price1, price2, price3, price4, price5, price6, price7, price8, price9, price10, price11, price12, price13, price14, price15, price16, price17, price18, price19, price20) VALUES ('" + pos_id_combobox.Text + "', '" + pricetextbox1.Text + "', '" + pricetextbox2.Text + "', '" + pricetextbox3.Text + "', '" + pricetextbox4.Text + "', '" + pricetextbox5.Text + "', '" + pricetextbox6.Text + "', '" + pricetextbox7.Text + "', '" + pricetextbox8.Text + "', '" + pricetextbox9.Text + "', '" + pricetextbox10.Text + "', '" + pricetextbox11.Text + "', '" + pricetextbox12.Text + "', '" + pricetextbox13.Text + "', '" + pricetextbox14.Text + "', '" + pricetextbox15.Text + "', '" + pricetextbox16.Text + "', '" + pricetextbox17.Text + "', '" + pricetextbox18.Text + "', '" + pricetextbox19.Text + "', '" + pricetextbox20.Text + "')";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterInsert();
                posdb_connect.pos_sql = "INSERT INTO pos_picTbl ( pic1, pic2, pic3, pic4, pic5, pic6, pic7, pic8, pic9, pic10, pic11, pic12, pic13, pic14, pic15, pic16, pic17, pic18, pic19, pic20) VALUES ('" + picpathtextbox1.Text + "', '" + picpathtextbox2.Text + "', '" + picpathtextbox3.Text + "', '" + picpathtextbox4.Text + "', '" + picpathtextbox5.Text + "', '" + picpathtextbox6.Text + "', '" + picpathtextbox7.Text + "', '" + picpathtextbox8.Text + "', '" + picpathtextbox9.Text + "', '" + picpathtextbox10.Text + "', '" + picpathtextbox11.Text + "', '" + picpathtextbox12.Text + "', '" + picpathtextbox13.Text + "', '" + picpathtextbox14.Text + "', '" + picpathtextbox15.Text + "', '" + picpathtextbox16.Text + "', '" + picpathtextbox17.Text + "', '" + picpathtextbox18.Text + "', '" + picpathtextbox19.Text + "', '" + picpathtextbox20.Text + "')";
                posdb_connect.pos_cmd();
                posdb_connect.pos_sqladapterInsert();
