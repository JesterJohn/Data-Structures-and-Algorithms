...
namespace Data_Structures_and_Algorithms
{
    internal class pos_dbconnection
    {
        ...
        {
            pos_sql = "SELEECT pos_empRegTbl.emp_id, emp_fname, emp_surname, pos_terminal_no, account_type FROM pos_empRegTbl INNER JOIN useraccountTbl ON pos_empRegTbl.emp_id = useraccountTbl.emp_id WHERE account_type = 'Administrator'";
        }
